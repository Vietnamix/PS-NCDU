...
function setLang(l){if(!I18N[l])return;LANG=l;try{localStorage.setItem('psncdu_lang',l);}catch(e){}document.documentElement.lang=l;document.documentElement.dir=/^(ar|ur|fa|he)$/.test(l)?'rtl':'ltr';applyI18n();onDepth();if(CUR)renderTree();}
var BROWSE_PATH='';
