...
![Fenêtre d'analyse PS-NCDU](PS-NCDU_scan_form_v6.27b.png)
...
- Les traductions des 30 langues les plus récentes sont au meilleur effort ; une relecture par des locuteurs natifs est bienvenue, en particulier pour l'amharique, le khmer, le birman, le haoussa et les langues indiennes.
...
- [ ] Relecture des traductions des 30 langues récentes par des locuteurs natifs
